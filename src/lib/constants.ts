...
export const seoImage = 'https://i.postimg.cc/X7WSX8Sb/design-min.png';
export const websiteImage = 'https://i.postimg.cc/TPpBBNmr/seo-min.png';
export const whyUsImage = 'https://i.postimg.cc/kgYDnwyt/whyus.png';

export const nodejsImage = 'https://i.postimg.cc/jSJVbJtk/nodejs.png';
export const postgresqlImage = 'https://i.postimg.cc/KYX6vvYc/postgresql.png';
export const reactImage = 'https://i.postimg.cc/LszrqKqt/react.png';
export const wordpressImage = 'https://i.postimg.cc/ZR4Xp731/wordpress.png';
...
const linkedInImage = 'https://i.postimg.cc/P5gYJ0ZQ/linkedin.png';
